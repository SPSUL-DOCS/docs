...
- _Právní subjektivita_ (způsobilost mát práva a povinnosti)

# Právnické osoby

- jsou organizace, které jsou vytvořeny lidmi a jsou požadovány za samostatný subjekt práv a povinností
- např. _obchodní společnostil, nadace, obce, kraje, příspěvkové organizace_
...
1. **Ohlašovací**
   ...
   1. **Řemeslné**
      ...
      - _Zedník, kadeřník, kuchař_
   1. **Vázané**
      - Vyjmenovány v příloze živnostenského zákona
      - Podmínkou je způsobilost v oboru, **výuční list** a **praxe v oboru**
      - _Lékárník, advokát, lékař_
1. **Koncesované**
   - Potvrzení státem, schválení od úřadů
   - _Přeprava osob, pořádání loterií, výroba lihovin_

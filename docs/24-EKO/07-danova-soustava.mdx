...
- **daňová povinnost** = DPH na vstupu - DPH na vstupu (tzn. plátce, který nakupuje určitě výrobky, platí v ceně daň na vstupu, při prodeji svých výrobků ceně DPH pripočtena, rozdíl je daňovou povinností)
- **sazba DPH**:
    - 21% 
    - 12% 
    - 0%

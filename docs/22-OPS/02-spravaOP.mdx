...
- **Musí plnit 5 věcí**: alokace, uvolňování, ochrana, přidělování, uvolňování
...
- Velikost tohoto tzv. virtuálního lépe logického adresového prostoru (LAP) není omezena velikostí skutečné OP, ale pouze velikostí adresy (u 32-bit adres $$ {2ˇ32} $$ = cca 4GB | u 64-bit adres 2ˇ64 = 16 EB)

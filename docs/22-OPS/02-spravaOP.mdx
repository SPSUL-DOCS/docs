...
- Pracovní množina stránek procesu (WP(t)) p v čase t
- WP(t) je množina těch rámců, k nimž proces přistupoval v čase \<t-Δt>, kde delta je časový interval krátký vzhledem běhu programu

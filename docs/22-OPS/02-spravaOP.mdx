...
- Předchozí přehled reakcí systému na výpadky stránek předpokládal, že fyzické OP je k dispozici téměř neomezené množství, tj. obsluha výpadku stránky vždy najde volný rámec
...
1. Počáteční podmínka (nenalezení volného rámce)
    ...
    - Při výpadku stránky je tabulka prohledána a pokud není nalezena volná stránka je zahájen proces **kradení rámce**y
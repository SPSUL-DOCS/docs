...
{/* - Bohužel i tak malá změna strategie výměny procesů si vyžádá rozsáhlé změny ve filozofii systémů Může mi dopíči kučera vysvětlit k čemu boha je tahle věta???*/}

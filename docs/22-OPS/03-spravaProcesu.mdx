...
- Sdílený logický prostředek, dva stavy (<Highlight color="red">červená</Highlight>, <Highlight color="green">zelená</Highlight>)
  - **WAIT**: pokud je semafor ve stavu <Highlight color="green">zelená</Highlight>, je bezprostředně přepnut do stavu <Highlight color="red">červená</Highlight>, jinak proces vyčká změny stavu na zelenou (Ta je provedena voláním operace signál jiným procesem a až poté změní sám stav semaforu na červenou, stav semaforu je změněn na zelenou)
...
- Lze použít k vzájemnému vyloučení u kritických kodu.

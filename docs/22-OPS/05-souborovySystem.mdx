...
### Nová struktura svazků
Data a metadata jsou duplikována blíže ke svazku.
To je výhodné pro cylindrické disky (HDD) u SSD tato výhoda zaniká 
